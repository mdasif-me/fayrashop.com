...
/**
 * Service component to display services in the form of a grid.
 *
 * It receives an array of services objects which contain the icon, title and description of each service.
 *
 * Each service is displayed as a grid item with the icon on top and the title and description below.
 *
 * The grid is divided into two columns on small screens and four columns on medium screens and above.
 *
 * The grid items are centered and have a gap of 4px between them.
 */
function Service() {
  return (
