...
export default function WelcomeEmail({ firstName, verificationUrl }: WelcomeEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>Welcome to FayraShop! Let's get you started.</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={logoContainer}>
            <Img
              src="https://fayrashop.com/logo.png"
              width="120"
              height="36"
              alt="FayraShop"
              style={logo}
          ...
          <Heading style={h1}>Welcome to FayraShop, {firstName}!</Heading>

          <Text style={text}>
            Thank you for joining us! We're excited to have you on board and can't wait to see what
            you'll build with our comprehensive FayraShop platform.
          </Text>
          ...
          <Text style={text}>
            ...
            our support team at{' '}
            <Link href="mailto:info.fayrashop@gmail.com" style={link}>
              info.fayrashop@gmail.com
            </Link>
          </Text>
          ...
          <Section style={footer}>
            <Text style={footerText}>© 2024 FayraShop. All rights reserved.</Text>
            <Text style={footerText}>
              <Link href="https://fayrashop.com/unsubscribe" style={footerLink}>
                Unsubscribe
              </Link>
              {' | '}
              <Link href="https://fayrashop.com/privacy" style={footerLink}>
                Privacy Policy
              </Link>
            </Text>
          </Section>
